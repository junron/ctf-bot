...
fun LocalDateTime.displayCTFDate(): String =
    DateTimeFormatter.ofPattern("dd MMM hh:mm a").format(this)

@UnstableDefault
val indentedJson = Json(JsonConfiguration(prettyPrint = true))

@UnstableDefault
val ignoreExtraJson = Json(JsonConfiguration(ignoreUnknownKeys = true))
